...
description: "Create API handoff documentation for frontend developers. Use AFTER backend development is complete to document APIs for frontend integration. SILENT output mode - produces only markdown documentation."
version: 1.0
priority: 7
...
workflow_position: |
  ...
  **Position in workflow: 7 of 7 (FINAL STEP)**
  ...
  **Previous Skills:** 
  ...
  6. backend-development (API implementation)
  
  **Purpose:** Final documentation for frontend handoff
  
  **⚠️ COMMUNICATION MODE: SILENT**
  This skill produces ONLY markdown documentation.
  NO conversational output. NO questions.
  
  **Use when:**
  - Backend work is complete
  - User says "create handoff", "document API", "frontend handoff"
  - Need to document APIs for frontend developers
  
  **Output:** API handoff markdown document
