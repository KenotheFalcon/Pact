...
description: "Technical implementation of responsive design patterns. THE authoritative source for container queries, fluid typography, CSS Grid, and breakpoint strategies. Other skills should reference this for technical responsive implementation."
version: 1.0
priority: 4
...
workflow_position: |
  ...
  **Purpose:** Technical responsive implementation
  
  **This is THE authoritative source for:**
  - Container queries and component-level responsiveness
  - Fluid typography and spacing scales
  - Breakpoint strategies and mobile-first patterns
  - CSS Grid and Flexbox responsive layouts
  
  **Other skills should NOT duplicate this content.**
  Instead, reference this skill for technical implementation details.
  
  **Next Skill:** web-design-guidelines (for validation)
  
  **Related Skills:**
  - frontend-design (for creative direction)
  - ui-ux-pro-max (for design patterns)
---
