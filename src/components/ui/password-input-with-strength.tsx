      ...
      {showStrengthIndicator && strength && value.length > 0 && (
        <div className="space-y-2" aria-live="polite">
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1 h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden" role="meter" aria-valuenow={strength.score} aria-valuemin={0} aria-valuemax={100} aria-label="Password strength">
              <div
